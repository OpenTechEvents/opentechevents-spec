...
(function () {
  ...
  var UI = {
    en: {
      ...
      "urls.npm": "The toolchain as packages: <a href=\"https://www.npmjs.com/package/@opentechevents/schema\"><code>schema</code></a> (the JSON Schemas), <a href=\"https://www.npmjs.com/package/@opentechevents/validate\"><code>validate</code></a> (validation with human-readable errors, CLI included), <a href=\"https://www.npmjs.com/package/@opentechevents/export-ics\"><code>export-ics</code></a> / <a href=\"https://www.npmjs.com/package/@opentechevents/export-rss\"><code>export-rss</code></a> (converters), <a href=\"https://www.npmjs.com/package/@opentechevents/build-feed\"><code>build-feed</code></a> (assemble, validate and export a feed). Pure functions, no network — for CI, build time or your own tools.",
    ...
    es: {
      ...
      "urls.npm": "La cadena de herramientas como paquetes: <a href=\"https://www.npmjs.com/package/@opentechevents/schema\"><code>schema</code></a> (los JSON Schema), <a href=\"https://www.npmjs.com/package/@opentechevents/validate\"><code>validate</code></a> (validación con errores legibles, CLI incluido), <a href=\"https://www.npmjs.com/package/@opentechevents/export-ics\"><code>export-ics</code></a> / <a href=\"https://www.npmjs.com/package/@opentechevents/export-rss\"><code>export-rss</code></a> (conversores), <a href=\"https://www.npmjs.com/package/@opentechevents/build-feed\"><code>build-feed</code></a> (ensambla, valida y exporta un feed). Funciones puras, sin red — para CI, build o tus propias herramientas.",
