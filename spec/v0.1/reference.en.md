# Field reference — OTE Spec 0.1.0
...
| --- | --- | :---: | --- | --- |
| `specVersion` | const: "0.1.0" | **yes** | Version of OTE Spec this document adheres to. | `"0.1.0"` |
...
| Field | Type | Required | Description | Examples |
| --- | --- | :---: | --- | --- |
| `specVersion` | const: "0.1.0" | **yes** | Version of OTE Spec this feed adheres to. Applies to every event in it. | `"0.1.0"` |
